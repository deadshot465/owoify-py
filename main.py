from Include.interleave_arrays import interleave_arrays
from Include.presets import *
...
def owoify(source: str, level: str) -> str:
...
if __name__ == '__main__':
    print(owoify('Hello there, Yuuto is on the roll!', 'uvu'))
